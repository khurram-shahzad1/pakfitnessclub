            ...
            <div class="col-xs-12 col-md-4">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<!-- Payment form -->
						<form action="submit_membership.php?amount=<?php echo dc($amount) ?>&membership_name=<?php echo dc($membership_name)?>&membership_id=<?php echo dc($membership_id)?>" method="post" id="paymentFrm">
