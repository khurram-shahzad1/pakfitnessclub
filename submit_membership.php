    ...
    if(empty($api_error) && $customer){  
        ...
        try {  
            ...
            if($charge){
                ...
                $sql="INSERT into `membership_orders` (user_id,membership_id,membership_name,membership_price) VALUES ('$user_id','$membership_id','$membership_name','$amount')";
...
<div class="container">
    ...
    <a href="index.php" class="btn-link">Back to Index</a>
</div>
