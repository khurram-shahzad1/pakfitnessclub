            ...
            <div class="col-xs-12 col-md-4">
				<div class="panel">
					<div class="panel-heading">
						<h3><b>Total Payment:</b> $<?php echo dc($amount) ?></h3>
					</div>
					<div class="panel-body">
						...
						<!-- Payment form -->
						<form action="submit.php?amount=<?php echo dc($amount) ?>&f_name=<?php echo $f_name; ?>&l_name=<?php echo $l_name;?>&user_id=<?php echo $user_id;?>&s_address=<?php echo $s_address;?>&city=<?php echo $city;?>&country=<?php echo $country;?>&p_code=<?php echo $p_code;?>&email=<?php echo $email;?>&phone=<?php echo $phone;?>&check_method=<?php echo $check_method;?>&pro_id=<?php echo $pro_id;?>&qty=<?php echo dc($qty)?>&size=<?php echo $size;?>" method="post" id="paymentFrm">
							...
							<button type="submit" class="btn btn-success" id="payBtn" style="background-color:#ec3642 !important;">Submit Payment</button>
						</form>
					</div>
				</div>
			</div>
